...
public class ExportIssueController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Cell cell25 = row4.createCell(9);
            styleSeceond.setFillForegroundColor(IndexedColors.LIGHT_GREEN.index);
            styleSeceond.setFillPattern(FillPatternType.SOLID_FOREGROUND);
            cell25.setCellStyle(styleSeceond);
            Cell cell26 = row4.createCell(11);
            styleSeceond.setFillForegroundColor(IndexedColors.LIGHT_GREEN.index);
            styleSeceond.setFillPattern(FillPatternType.SOLID_FOREGROUND);
            cell26.setCellStyle(styleSeceond);

            int issueID = Integer.parseInt(request.getParameter("issueID"));
            List<UserIssueFull> list = dao.getListIssueFull(issueID);
            if (list != null) {
                if (list.size() > 0) {
                    int i = 1;
                    for (UserIssueFull tm : list) {
                        if (i % 2 == 0) {
                            ...
                            cellC.setCellValue(tm.getModel());
                            styleLast.setFillForegroundColor(IndexedColors.GREY_25_PERCENT.index);
                            styleLast.setFillPattern(FillPatternType.SOLID_FOREGROUND);
                            cellC.setCellStyle(styleLast);

                            cellD = row5.createCell((short) 10);
                            cellD.setCellValue(tm.getBrand());
                            styleLast.setFillForegroundColor(IndexedColors.GREY_25_PERCENT.index);
                            styleLast.setFillPattern(FillPatternType.SOLID_FOREGROUND);
                            cellD.setCellStyle(styleLast);

                            cellE = row5.createCell((short) 12);
                            cellE.setCellValue(tm.getQuantity());
                            styleLast.setFillForegroundColor(IndexedColors.GREY_25_PERCENT.index);
                            styleLast.setFillPattern(FillPatternType.SOLID_FOREGROUND);
                            ...
                            cellV = row5.createCell((short) 9);
                            styleLast.setFillForegroundColor(IndexedColors.GREY_25_PERCENT.index);
                            styleLast.setFillPattern(FillPatternType.SOLID_FOREGROUND);
                            cellV.setCellStyle(styleLast);
                            cellM = row5.createCell((short) 11);
                            styleLast.setFillForegroundColor(IndexedColors.GREY_25_PERCENT.index);
                            styleLast.setFillPattern(FillPatternType.SOLID_FOREGROUND);
                            cellM.setCellStyle(styleLast);
            ...
            List<UserIssueFull> listT = dao.getListIssueFull(issueID);
            if (listT != null) {
                if (listT.size() > 0) {
                    for (UserIssueFull tm : listT) {
                        ...
                        row6 = sheet.createRow((short) listT.size() + 1 + 5);
                        cellQ = row6.createCell((short) 0);
                        cellQ.setCellValue("Tổng số lượng: " + dao.getTotalQuantity(tm.getIssueID()));

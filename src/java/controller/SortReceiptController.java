...
import sort.SortReceiptDateA;
import sort.SortReceiptDateD;

/**
 *
 * @author 84348
 */
@WebServlet(name = "SortReceiptController", urlPatterns = {"/SortReceiptController"})
public class SortReceiptController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(search.equalsIgnoreCase("1")){
                Collections.sort(receipt, new SortReceiptDateA());
                url=SUCCESS;
            }else{
                Collections.sort(receipt, new SortReceiptDateD()); 
                url=SUCCESS;
            }
